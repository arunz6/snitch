   ...
   <div className="min-h-screen bg-background text-on-background px-margin-mobile md:px-margin-desktop py-16 max-w-container-max mx-auto">
      ...
      <section className="mb-16">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
          Manage and curate your listed pieces. Each entry represents our commitment
          to automotive excellence and luxury detailing services.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
        ...
        {/* Add New Card */}
        <div className="group flex flex-col justify-center items-center gap-4 cursor-pointer border border-dashed border-outline-variant p-4 hover:bg-surface-container-lowest transition-all duration-500 min-h-[500px]" 
